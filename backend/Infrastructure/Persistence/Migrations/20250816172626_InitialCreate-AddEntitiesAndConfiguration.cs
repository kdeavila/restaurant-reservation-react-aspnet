...
{
    /// <inheritdoc />
    public partial class InitialCreateAddEntitiesAndConfiguration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePricePerHour = table.Column<decimal>(
                        type: "decimal(18,2)",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SurchargePercentage = table.Column<decimal>(
                        type: "decimal(5,2)",
                        nullable: false
                    ),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PricingRules_TableTypes_TableTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingRules_TableTypeId",
                table: "PricingRules",
                column: "TableTypeId"
            );
        ...
        {
            migrationBuilder.DropTable(name: "PricingRuleDays");
            ...
            migrationBuilder.DropTable(name: "TableTypes");
        }
    }
}
