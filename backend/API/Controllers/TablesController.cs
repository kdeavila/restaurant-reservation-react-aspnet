...
public class TablesController(ITableService tableService) : ControllerBase
{
    ...
    public async Task<ActionResult<ApiResponse<IEnumerable<TableDetailedDto>>>> GetAll(
        [FromQuery] TableQueryParams queryParams,
    ...
    )
    {
        ...
        if (result.IsFailure)
            return StatusCode(
                result.StatusCode,
                ApiResponse<TableDetailedDto>.ErrorResponse(
                    result.Error,
    ...
    public async Task<ActionResult<ApiResponse<TableDetailedDto>>> Create(
    ...
    )
    {
        ...
        return Ok(
            ApiResponse<TableDetailedDto>.SuccessResponse(updatedResult.Value, "Table updated")
        );
    }
